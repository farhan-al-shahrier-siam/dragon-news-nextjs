            ...
            <div className="card-body">
                ...
                <div>
                    <Link href={`/news/${news._id}`}>
                        <button className="text-orange-400 font-semibold cursor-pointer">Read More</button>
                    </Link>
                    <div className="flex items-center justify-between border-t-2 border-gray-500 pt-2 mt-4">
                        ...
                        <div className="flex items-center justify-between gap-2 font-bold"> <FaEye /> {news.total_view}</div>
                    </div>
                </div>
            </div>
        </div>
